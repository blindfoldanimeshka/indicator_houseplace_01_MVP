// This file is used inside vi.hoisted() blocks.
// It must NOT import from vitest or any other module.
// It uses `vi` from vitest globals which is available globally.
...
export function createMockSupabaseFactory() {
  ...
  return { supabase, fromSpy, mockTableData, mockInsertReturn, mockSequential, reset };
}
