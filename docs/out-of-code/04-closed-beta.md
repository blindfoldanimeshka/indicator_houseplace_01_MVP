...
пока проект ещё маленький и правки дешёвы. По `docs/out-of-code/plan-legacy-nextjs.md` (шаги 8–10):
...
## 4. Процесс беты (по `docs/out-of-code/plan-legacy-nextjs.md`, шаги 8–10)
