  ...
  return (
    <section className="space-y-6">
      <div className="rounded-2xl border border-stone-200 p-5">
        <h2 className="text-base font-semibold text-stone-950">Выйти</h2>
        ...
        <button
          ...
          disabled={loading}
          className="mt-4 rounded-xl border border-stone-300 px-4 py-2.5 text-sm font-semibold text-stone-800 transition hover:bg-stone-100 disabled:opacity-60"
        >
          Выйти
        </button>
      </div>
